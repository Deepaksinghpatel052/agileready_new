...
class ArShowcolumns(models.Model):
    ...
    user = models.ForeignKey(Ar_user,on_delete=models.CASCADE , default="",null=True)
    ORG = models.ForeignKey(AR_organization, on_delete=models.SET_NULL,  default="",null=True , blank=True)
